...
<tab>Student# <tab> Given Name <tab>  Family Name <tab> Course Grade  
```
...
<tab>prompt> circle.pl 4
<tab>The radius of circle is 4.
<tab>The circumference of the circle is 25.12
<tab>The area of the circle is 50.24
```  
  
### getAverage.pl  
  
```
Write a perl script getAverage.pl, which will recognize the following three options to compute the average score on the corresponding lab, exam, or the final, respectively. 
<tab>-l number
<tab>-e number
<tab>-f
